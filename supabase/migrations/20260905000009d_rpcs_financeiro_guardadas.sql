-- ================================================================
--  Fase 7d — Trava de permissão dentro das RPCs financeiras
-- ================================================================
-- Essas RPCs já existiam (Fases 5 e 6) e são SECURITY DEFINER -
-- rodam como dono da função, ignorando a RLS da tabela. Sem essa
-- checagem explícita aqui dentro, um usuário 'atendente' continuaria
-- conseguindo criar/baixar contas ou ver a DRE só chamando a RPC em
-- vez de mexer na tabela direto (a RLS da fase 7b não seria
-- suficiente sozinha).
